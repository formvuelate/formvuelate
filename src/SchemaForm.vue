<template>
  <component :is="!hasParentSchema ? 'form' : 'div'" v-bind="formBinds">
    <slot v-if="!hasParentSchema" name="beforeForm" />

    <div
      :class="[
        additionalClassSchema === '' ? 'schema-row' : additionalClassSchema,
      ]"
    ...
    <slot v-if="!hasParentSchema" name="afterForm" />
  </component>
</template>
